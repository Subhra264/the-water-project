  ...
  return (
    <div className="topic-address">
      <div className="topic-address-label">
        Country {props.required ? '(Required)' : ''}
      </div>
      <div className="topic-address-input">
        <select
          name="category"
          id="category"
          ref={props.selectedCountry}
...
export default function TopicEditor(props) {
  ...
  onSubmitClick.current = (topic) => {
    ...
    if (ngoSelector.current && ngoSelector.current.value) {
  ...
  contentEditorProps.current = {
    ...
    contentEditorPlaceholder:
      'Describe the topic with as much detail as possible',
  };
  ...
  return (
    <ContentEditor {...contentEditorProps.current} error={error}>
      <div className="topic-address-container">
        ...
        <div className="topic-address">
          <div className="topic-address-label">City/Area (Required)</div>
          <div className="topic-address-input">
            <input
              type="text"
              value={cityOrArea}
              onChange={onCityOrAreaChange}
              placeholder="City/Area, e.g.London"
            />
          </div>
        </div>
        <div className="topic-address">
          <div className="topic-address-label">Address (Required)</div>
          <div className="topic-address-input">
            <textarea
              value={address}
      ...
      <ImgSelector
        ...
        title="Choose an image for the thumbnail"
      />
    </ContentEditor>
  );
}
