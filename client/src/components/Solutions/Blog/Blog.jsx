        ...
        <>
          ...
          <div className="blog-writer-date">
            <div className="blog-writer">
              Written by{' '}
              <Link to={`/discussion/users/${blog.creator.id}`}>
                <i>@{blog.creator.username}</i>
              </Link>{' '}
            </div>
            <div className="blog-date">
              Last Updated on {parseDate(blog.updated_on)}
            </div>
          </div>
          <div className="blog-content">
            {blog.front_img && (
              <img
                src={blog.front_img}
                title={`Front image of ${blog.title}`}
                alt={`${blog.title}`}
              />
            )}
          ...
          <div className="blog-meta-tags">
            ...
            {blog.tags.map((tag) => (
              <div className="blog-meta-tag" key={tag.id}>
                {tag.name}
              </div>
            ))}
          </div>
