  ...
  useEffect(() => {
    ...
    for (const param in props.searchParams) {
      if (props.searchParams[param].value) {
        urlSearchParams.current.set(
          props.searchParams[param].query,
          props.searchParams[param].value,
        );
      ...
      <div className="search-bar">
        ...
        <div className="new-problem">
          <Link to={`${matchURL}/new-topic`}>
            ...
            <i className={`${isMobile ? 'display-none' : 'new-problem-label'}`}>
              New Problem
            </i>
          </Link>
        </div>
          ...
          {addedFilters.map((filter, index) => (
            ...
            <span className="label" key={filter.query}>
              <span
                ...
                onClick={() => removeFilter(index, filter.query)}
              >
                &times;
              </span>
