    ...
    return (
        <div className={`filters-container ${isMobile? 'mobile' : ''}`}>
            <div className="filters-label-container">
                ...
                {
                    isMobile && <div className="toggle-filters" onClick={toggleShowFilters}>
                        <FontAwesomeIcon icon={`${showFilters? 'chevron-up' : 'chevron-down'}`} />
                    </div>
                }
            </div>
            <div className={`filters ${isMobile? showFilters? '' : 'display-none' : ''}`}>
                <div className="filter-group">
                    <div className="filter-label">
                        Topic status
                    </div>
                    <select id="topic-status" value={isClosed} onChange={changeTopicStatus}>
                ...
                <div className="filter-group">
                    ...
                    <input type='number' value={noOfIssues} min={0} onChange={changeNoOfIssues}/>
                </div>
                ...
                <div className="filter-group">
                    ...
                    <select id="progress-report-status" 
                        value={progressReportCompleted}
                ...
                <div className="filter-group">
                    <div className="filter-label">
                        Number of Tasks in Progress Report
                    </div>
                    <input 
                        type='number'
                        value={noOfProgressReportTasks}
                ...
                <div className="filter-group">
                    ...
                    <input type='number' value={issuesGTE} min={0} onChange={changeIssuesGTE} />
                </div>
                ...
                <div className="filter-group">
                    ...
                    <input type='number' value={issuesLTE} min={0} onChange={changeIssuesLTE} />
                </div>
