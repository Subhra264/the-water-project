...
export default function Description(props) {
  ...
  return (
    <div className="problem-description">
      <Comment isDescription {...props.description} baseURI={props.baseURI} />
      {props.isClosed ? (
        ...
        <>
          {administratorAccess ||
          isThisUser(userState, props.description.creator.id) ? (
            <div className="close-button-container">
              <button onClick={closeTopic}>Close {props.problemType}</button>
            </div>
          ) : (
            ''
          )}
