...
export default function ProgressReport (props) {
    ...
    const markAsCompleted = (taskId, index) => {
        completedTasks.current.push(taskId);

        // Mark the selected task as completed
        const existingTasks = [...progressReport.task_set];
        existingTasks[index].is_completed = true;
                                            ...
                                            <div className="progress-report-task" key={task.id}>
                                                ...
                                                <div className="task-buttons-container">
                                                    <div className="task-buttons">
                                                        ...
                                                        <span className="task-button done-button" onClick={markAsCompleted(task.id, index)} title={`Mark as ${task.is_completed? '' : 'In' }Completed`} >
                                                            <FontAwesomeIcon icon={`${task.is_completed? 'check-square' : ['far', 'check-square']}`} />
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
